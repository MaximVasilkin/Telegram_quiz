...
async def answering(callback: CallbackQuery,
    ...
    if next_question_index > QUIZ_LEN - 1:
        ...
        p_s_ = html.italic(('Как создать идеальный сад не только для себя, но и для клиента, '
                            'мы расскажем на нашем вебинаре, посвященном психологии в ландшафтном дизайне 4 июня.\n'
                            'Если вы еще не успели зарегистрироваться на вебинар "Психология в ландшафтном дизайне", '
                            f'можете сделать это, перейдя по {html.link("ссылке", "https://school.garden-group.online/psychology_landscape")}\n\n'
                            'С любовью, \n'
